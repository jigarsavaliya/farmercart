package com.farmercats.com.adapters;
...
import com.farmercats.com.customs.DialogLoader;
import com.farmercats.com.models.product_model.Attribute;
import com.farmercats.com.models.product_model.GetStock;
import com.farmercats.com.models.product_model.ProductStock;
...
import com.farmercats.com.models.product_model.Option;
import com.farmercats.com.models.product_model.Value;
import com.farmercats.com.utils.Utilities;
import com.farmercats.com.activities.Login;
import com.farmercats.com.databases.User_Recents_DB;
import com.farmercats.com.fragment.My_Cart;
import com.farmercats.com.fragment.Product_Description;
...
import com.farmercats.com.models.cart_model.CartProduct;
import com.farmercats.com.models.cart_model.CartProductAttributes;
import com.farmercats.com.models.product_model.ProductDetails;
...
//                        if (holder.attribute_recycler != null)
//                        setAttributes(holder,product);
                    }
                }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final RecyclerView attribute_recycler;
        long start;
        long end;
        long server;
        ...
        public MyViewHolder(final View itemView) {
            ...
            attribute_recycler = (RecyclerView) itemView.findViewById(R.id.product_attributes_recycler);
...
private void setAttributes(MyViewHolder holder, ProductDetails productDetails){
    if (productDetails.getProductsType() == 1) {
        List<Attribute> attributesList=productDetails.getAttributes();
        if (attributesList.size() > 0) {
            holder.attribute_recycler.setVisibility(View.VISIBLE);
            ...
            ProductAttributesAdapter  attributesAdapter = new ProductAttributesAdapter(context, ProductAdapter.this, attributesList, selectedAttributesList);

            // Set the Adapter and LayoutManager to the RecyclerView
            holder.attribute_recycler.setAdapter(attributesAdapter);
            holder.attribute_recycler.setLayoutManager(new LinearLayoutManager(context, RecyclerView.VERTICAL, false));
            attributesAdapter.notifyDataSetChanged();


            RequestProductStock(productDetails, attributesAdapter.getAttributeIDs());

        } else {
            holder.attribute_recycler.setVisibility(View.GONE);
        }
    } else {
        holder.attribute_recycler.setVisibility(View.GONE);
    }
    ...
    public void RequestProductStock(final ProductDetails product, List<String> attributes) {
        final DialogLoader  dialogLoader = new DialogLoader(context);
        dialogLoader.showProgressDialog();

        GetStock getStock = new GetStock();
        getStock.setProductsId(String.valueOf(product.getProductsId()));
            ...
            public void onResponse(Call<ProductStock> call, retrofit2.Response<ProductStock> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().getSuccess().equalsIgnoreCase("1")) {
                        ...
                        updateProductStock(response.body().getStock(),product);
    ...
    public void updateProductStock(String stock, ProductDetails productDetails) {
...
//            product_stock.setTextColor(ContextCompat.getColor(context, R.color.colorAccentRed));
//            productCartBtn.setBackground(ContextCompat.getDrawable(context, R.drawable.rounded_corners_button_red));
//
//        } else {
