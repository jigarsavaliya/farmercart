                ...
                .addOnCompleteListener(Login.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Log.d("PHONE:TAG", "onComplete: "+new Gson().toJson(task.getResult().getUser()));
                            //verification successful we will start the profile activity
                            dialogOTP.dismiss();

                            userDetails=new UserDetails();
                            userDetails.setEmail(task.getResult().getUser().getPhoneNumber());
                            userDetails.setPhone(task.getResult().getUser().getPhoneNumber());
                            userDetails.setId(task.getResult().getUser().getUid());
